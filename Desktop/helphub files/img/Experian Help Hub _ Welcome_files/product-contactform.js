...
$(document).ready(function() {
	$("#contactForm form").attr("accept-charset","ISO-8859-15");
...
function initFormVersion1(jCurrentForm){ // legacy forms
	...
	if(location.search.match(/send=yes$/g)){
		...
		jCurrentForm.hide();
		if(jCurrentForm.find('input[name="link"]').length > 0 && jCurrentForm.find('input[name="link"]').val() != ''){
				var url = jCurrentForm.find('input[name="link"]').val();
