...
Plugins:
    ...
    * Plugin: getDaysSinceLastVisit 1.1.H  (modified)
    ...
    * Plugin: setupFormAnalysis 2.1
Utilities:
    * Utility: Append List (apl) v1.1
    * Utility: Join v1.0
    * Utility: Replace v1.0
    * Utility: Split v1.5
    * Utility: p_c
    * Utility: p_gh
Functions:
    * Function: read combined cookies v0.37
    * Function: write combined cookies v0.37
Modules: 
    * TNT Integration Plugin v1.0
    * Module: Media
*/

var s_account="expiukexperianukprod,expiukexperiancreditprod";

var s_ce = s_gi(s_account);

/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s_ce.cookieDomainPeriods="3";

/* Link Tracking Config */
s_ce.trackDownloadLinks = true;
s_ce.trackExternalLinks = true;
s_ce.trackInlineStats = true;
s_ce.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx";
s_ce.linkInternalFilters = "javascript:,experian.co.uk";
s_ce.linkLeaveQueryString = false;
s_ce.linkTrackVars = "None";
s_ce.linkTrackEvents = "None";

/* Plugin Config */
s_ce.usePlugins = true;
s_ce._tpDST = {
    2012:'3/25,10/28',
    2013:'3/31,10/27',
    2014:'3/30,10/26',
...
s_ce.formList = "";
s_ce.trackFormList = false;
s_ce.trackPageName = false;
s_ce.useCommerce = true;
s_ce.varUsed = "eVar23";
s_ce.eventList = "event12"; //Abandon,Success,Error

/* Set local variables */

function s_ce_doPlugins(s_ce) {
    
    /* Set Variables from the Query String */
    var qs_AffiliateID = s_ce.getQueryParam('affiliateid'); 
    var qs_BannerCode = s_ce.getQueryParam('bcd'); 
    var qs_SourceCode  = s_ce.getQueryParam('sc'); 
    
    /* Set Variables from the Document */
    var doc_Domain = document.domain;
    var doc_URL = document.URL;
    var doc_Agent = navigator.userAgent;
    
    /* Set Page Name Variables */
    var pg_Site = "Experian UK";
    var pg_PageClass = "Public";
    var pg_PageSection = "";
    var pg_PageSubSection = "";
    var pg_PageName = "";
    var pg_PageNameFull = "";
    var pg_PageNameArray;
    
    /* If Page Name is not set on the page use the URL path */
    if (!s_ce.pageName) {  
        // Capture URL and reformat
        pg_PageNameFull = window.location.pathname;
        var nStrEnd = (pg_PageNameFull.indexOf(".") != -1) ? pg_PageNameFull.indexOf(".") : pg_PageNameFull.length;  // Remove any trailing file types
        pg_PageNameFull = pg_PageNameFull.substring(1,nStrEnd);
        
        if (pg_PageNameFull == "/" || pg_PageNameFull == "") {
            pg_PageNameFull = "Home";
        } else {
            pg_PageNameFull = pg_PageNameFull.replace(/\/(index)?$/, ' : Home');  // Remove trailing "/" or "/index.html".
            pg_PageNameFull = pg_PageNameFull.replace(/_|-|~/g, ' ');             // Replace spacer characters with spaces.
            pg_PageNameFull = pg_PageNameFull.replace(/(^|\/| )[a-z]/g, function(str) {return str.toUpperCase();});  // Capitalise the first character of each word.
            pg_PageNameFull = pg_PageNameFull.replace(/\//g, ' : ');              // Replace "/" with new seperators.
        }
        pg_PageNameFull = pg_Site + " : " + pg_PageClass + " : "  + pg_PageNameFull;
        
        s_ce.pageName = pg_PageNameFull;
    } else {
        pg_PageNameFull = s_ce.pageName;  // If there is a page name already on the page copy that to the local variable
    }
    
    /* Set Omniture pathing variables */
    pg_PageNameArray = pg_PageNameFull.split(" : ");
    pg_PageSection = (pg_PageNameArray.length >= 2) ? pg_PageNameArray[2] : "";
    pg_PageSubSection = (pg_PageNameArray.length >= 3) ? pg_PageNameArray[3] : "";
    pg_PageName = (pg_PageNameArray.length >= 4) ? pg_PageNameArray.slice(4).join(" : ") : "";
    
    /* If Omniture Channel is not expilictly set on the page set it here */
    if (!s_ce.channel) {
        s_ce.channel = pg_PageNameArray.slice(0,3).join(" : ");
    }
    
    /* Set Omniture Hierachy variable */
    s_ce.hier1 = pg_PageNameFull.replace(/ : /g, ',');  // Replace all " : " seperators with commas.
    
    /* Set Omniture pathing variables */
    s_ce.prop2 = doc_Domain;                        // Domain
    s_ce.prop3 = pg_PageClass;                      // Level 1: Page Class
    s_ce.prop4 = pg_PageSection;                    // Level 2: Page Section
    s_ce.prop5 = pg_PageSubSection;                 // Level 3: Page Subsection
    s_ce.prop7 = s_ce.prop4 + "/" + s_ce.prop5;     // Join L2/L3
    s_ce.prop8 = s_ce.prop4 + "/" + s_ce.prop5;     // Join L2/L3 (HLSP)
    s_ce.prop9 = s_ce.prop3 + "/" + s_ce.prop7 + "/" + pg_PageName;   // Join L1/L2/L3/L4
    s_ce.prop10 = doc_Domain + "/" + doc_Agent + "/" + s_ce.prop9;    // Join: Domain/Experience/L1/L2/L3/L4
    s_ce.prop11 = s_ce.prop3 + "/" + pg_PageName;   // Join L1/L4
    s_ce.prop13 = qs_BannerCode;                    // Banner Code (from ECD Object)
    s_ce.prop14 = qs_SourceCode;                    // Source Code
    s_ce.prop16 = s_ce.prop14 + ":" + s_ce.prop13;  // SC:BCD  
    s_ce.prop26 = s_ce.eVar34 = s_ce.getPreviousValue(s_ce.pageName, 'gpv', '');    // Previos Page Name
    if (s_ce.prop26) s_ce.prop18 = s_ce.getPercentPageViewed(); // Percent of Page Viewed

    /* External Campaign Tracking */
    s_ce.campaign = qs_SourceCode;
    s_ce.campaign = s_ce.getValOnce(qs_SourceCode, 's_ev0', 0);
    
    /* Set Omniture eVars */    
    s_ce.eVar1 = doc_Domain;                        // Domain
    s_ce.eVar2 = doc_Agent;                         // Environment (User Agent)
    s_ce.eVar3 = s_ce.prop1;                        // Site Version
    s_ce.eVar4 = s_ce.getValOnce(qs_AffiliateID, 's_ev4', 0);   // Affiliate ID
    s_ce.eVar5 = s_ce.prop3;                        // Level 1: Page Class
    s_ce.eVar6 = s_ce.prop4;                        // Level 2: Page Section
    s_ce.eVar7 = s_ce.prop5;                        // Level 3: Page Subsection
    s_ce.eVar8 = pg_PageName;                       // Level 4: Page Name
    s_ce.eVar9 = s_ce.prop6;                        // Level 5: Page Content Detail
    s_ce.eVar11 = s_ce.prop10;                      // Join: Domain/Experience/SiteVersion/L1/L2/L3/L4/L5 
    s_ce.eVar14 = s_ce.getValOnce(qs_BannerCode,'s_ev14',0);    // Banner Code (from query string)
    s_ce.eVar15 = s_ce.prop14;                      // Source Code
    s_ce.eVar17 = s_ce.prop13 + ":";                // BCD:OrderID
    s_ce.eVar18 = s_ce.prop16;                      // SC:BCD
    s_ce.eVar20 = s_ce.getNewRepeat(365);           // New / Repeat Visitors
    s_ce.eVar21 = s_ce.getTimeParting('n', '+0');   // Day and Time Parting
    s_ce.eVar37 = s_ce.getDaysSinceLastVisit('s_lv');   // Days Since Last Visit
    s_ce.eVar50 = doc_URL;                          // Page URL
         
    //s_ce.setupFormAnalysis();
    s_ce.trackTNT();
    
    /* Set Page View Event */
    s_ce.events = s_ce.apl(s_ce.events, 'event1', ',', 2); 
}

s_ce.doPlugins = s_ce_doPlugins;
 ...
 */ 
s_ce.crossVisitParticipation=new Function("v","cn","ex","ct","dl","ev","dv",""
 ...
 * Modified
 */ 
s_ce.getDaysSinceLastVisit=new Function("c",""
+"var s=this,e=new Date(),es=new Date(),cval,cval_s,cval_ss,ct=e.getT"
+"ime(),day=24*60*60*1000,f1,f2,f3,f4,f5,f6,f7;e.setTime(ct+3*365*day"
+");es.setTime(ct+30*60*1000);f0 = 'Cookies Not Supported';f1 = 'Firs"
+"t Visit';f2 = 'Less than 1 day';f3 = 'Between 1 - 3 days';f4 = 'Bet"
+"ween 4 - 7 days';f5 = 'Between 8 - 14 days';f6 = 'Between 15 - 21 d"
+"ays';f7 = 'Between 22 - 30 days';f8 = 'Between 31 - 90 days';f9 = '"
+"More than 90 days';cval=s.c_r(c);if(cval.length==0){s.c_w(c,ct,e);s"
+".c_w(c+'_s',f1,es);}else{var d=ct-cval;if(d>30*60*1000){if(d>90*day"
+"){s.c_w(c,ct,e);s.c_w(c+'_s',f9,es);}else if(d<90*day+1&&d>30*day){"
+"s.c_w(c,ct,e);s.c_w(c+'_s',f8,es);}else if(d<30*day+1&&d>21*day){s."
+"c_w(c,ct,e);s.c_w(c+'_s',f7,es);}else if(d<21*day+1&&d>14*day){s.c_"
+"w(c,ct,e);s.c_w(c+'_s',f6,es);}else if(d<14*day+1&&d>7*day){s.c_w(c"
+",ct,e);s.c_w(c+'_s',f5,es);}else if(d<7*day+1&&d>3*day){s.c_w(c,ct,"
+"e);s.c_w(c+'_s',f4,es);}else if(d<3*day+1&&d>day){s.c_w(c,ct,e);s.c"
+"_w(c+'_s',f3,es);}else if(d<day+1){s.c_w(c,ct,e);s.c_w(c+'_s',f2,es"
+");}}else{s.c_w(c,ct,e);cval_ss=s.c_r(c+'_s');s.c_w(c+'_s',cval_ss,e"
+"s);}}cval_s=s.c_r(c+'_s');if(cval_s.length==0) return f0;else if(cv"
+"al_s!=f1&&cval_s!=f2&&cval_s!=f3&&cval_s!=f4&&cval_s!=f5&&cval_s!=f"
+"6&&cval_s!=f7&&cval_s!=f8&&cval_s!=f9) return '';else return cval_s;");

/*
 * Plugin: getNewRepeat 1.2 - Returns whether user is new or repeat
 */
s_ce.getNewRepeat=new Function("d","cn",""
 ...
 * Plugin: getPercentPageViewed v1.5
 */
s_ce.handlePPVevents=new Function("",""
+"var s=s_c_il["+s_ce._in+"];if(!s.getPPVid)return;var dh=Math.max(Math."
...
s_ce.getPercentPageViewed=new Function("pid",""
 ...
 */
s_ce.getPreviousValue=new Function("v","c","el",""
 ...
 * Plugin: getQueryParam 2.4
 */
s_ce.getQueryParam=new Function("p","d","u","h",""
...
s_ce.p_gpv=new Function("k","u","h",""
+"var s=this,v='',q;j=h==1?'#':'?';i=u.indexOf(j);if(k&&i>-1){q=u.sub"
+"string(i+1);v=s.pt(q,'&','p_gvf',k)}return v");

s_ce.p_gvf=new Function("t","k",""
 ...
 * Plugin: getTimeParting 3.4
 */
s_ce.getTimeParting=new Function("h","z",""
 ...
 * Plugin: getValOnce_v1.11
 */
s_ce.getValOnce=new Function("v","c","e","t",""
 ...
 */
s_ce.setupFormAnalysis=new Function(""
+"var s=this;if(!s.fa){s.fa=new Object;var f=s.fa;f.ol=s.wd.onload;s."
+"wd.onload=s.faol;f.uc=s.useCommerce;f.vu=s.varUsed;f.vl=f.uc?s.even"
+"tList:'';f.tfl=s.trackFormList;f.fl=s.formList;f.va=new Array('',''"
+",'','')}");

s_ce.sendFormEvent=new Function("t","pn","fn","en",""
+"var s=this,f=s.fa;t=t=='s'?t:'e';f.va[0]=pn;f.va[1]=fn;f.va[3]=t=='"
+"s'?'Success':en;s.fasl(t);f.va[1]='';f.va[3]='';");

s_ce.faol=new Function("e",""
+"var s=s_c_il["+s_ce._in+"],f=s.fa,r=true,fo,fn,i,en,t,tf;if(!e)e=s.wd."
...
s_ce.faos=new Function("e",""
+"var s=s_c_il["+s_ce._in+"],f=s.fa,su;if(!e)e=s.wd.event;if(f.vu){s[f.v"
+"u]='';f.va[1]='';f.va[3]='';}su=f.os[this.name];return su?su(e):tru"
+"e;");

s_ce.fasl=new Function("e",""
+"var s=s_c_il["+s_ce._in+"],f=s.fa,a=f.va,l=s.wd.location,ip=s.trackPag"
...
s_ce.fam=new Function("e",""
+"var s=s_c_il["+s_ce._in+"],f=s.fa;if(!e) e=s.wd.event;var o=s.trackLas"
...
s_ce.ee=new Function("e","n",""
+"return n&&n.toLowerCase?e.toLowerCase()==n.toLowerCase():false;");

s_ce.fage=new Function("e","a",""
+"var s=this,f=s.fa,x=f.cnt;x=x?x+1:1;f.cnt=x;return x==a?e:'';");

/* Utility Fuctions */

/*
 * Plugin Utility: Append List (apl) v1.1
 */
s_ce.apl=new Function("L","v","d","u",""
...
if(!s_ce.__ccucr)
{
    ...
    function c_rspers()
    {
        var cv=s_ce.c_rr("s_pers");var date=new Date().getTime();var expd=null;
...
if(!s_ce.__ccucw)
{
    s_ce.c_wr=s_ce.c_w;s_ce.__ccucw=true;
    function c_w(k, v, e)
    {
...
* TNT Integration Plugin v1.0
*/
s_ce.trackTNT =new Function("v","p","b",""
...
/****************************** MODULES *****************************/
/* Module: Media */
s_ce.m_Media_c="var m=s.m_i('Media');if(m.completeByCloseOffset==undefined)m.completeByCloseOffset=1;if(m.completeCloseOffsetThreshold==undefined)m.completeCloseOffsetThreshold=1;m.cn=function(n){var"
+" m=this;return m.s.rep(m.s.rep(m.s.rep(n,\"\\n\",''),\"\\r\",''),'--**--','')};m.open=function(n,l,p,b){var m=this,i=new Object,tm=new Date,a='',x;n=m.cn(n);if(!l)l=-1;if(n&&p){if(!m.l)m.l=new Obje"
+"ct;if(m.l[n])m.close(n);if(b&&b.id)a=b.id;if(a)for (x in m.l)if(m.l[x]&&m.l[x].a==a)m.close(m.l[x].n);i.n=n;i.l=l;i.o=0;i.x=0;i.p=m.cn(m.playerName?m.playerName:p);i.a=a;i.t=0;i.ts=0;i.s=Math.floor"
+"(tm.getTime()/1000);i.lx=0;i.lt=i.s;i.lo=0;i.e='';i.to=-1;i.tc=0;i.fel=new Object;i.vt=0;i.sn=0;i.sx=\"\";i.sl=0;i.sg=0;i.sc=0;i.us=0;i.ad=0;i.adpn;i.adpp;i.adppp;i.clk;i.CPM;i.co=0;i.cot=0;i.lm=0;"
+"i.lom=0;m.l[n]=i}};m.openAd=function(n,l,p,pn,pp,ppp,CPM,b){var m=this,i=new Object;n=m.cn(n);m.open(n,l,p,b);i=m.l[n];if(i){i.ad=1;i.adpn=m.cn(pn);i.adpp=pp;i.adppp=ppp;i.CPM=CPM}};m._delete=funct"
...
+"ew Object;i.m.m=new Function('var m=s_c_il['+m._in+'],i;if(m.l){i=m.l[\"'+m.s.rep(i.n,'\"','\\\\\"')+'\"];if(i){if(i.lx==1)m.e(i.n,3,-1);i.m.i=setTimeout(i.m.m,1000)}}');i.m.m()}};m.click=function("
...
+"'timePlayed']=Math.floor(i.ts);if(!i.vt){c[ns+'view']=true;pe='m_s';i.vt=1}if(i.sx){c[ns+'segmentNum']=i.sn;c[ns+'segment']=i.sx;if(i.sl>0)c[ns+'segmentLength']=i.sl;if(i.sc&&i.ts>0)c[ns+'segmentVi"
+"ew']=true}if(!i.cot&&i.co){c[ns+\"complete\"]=true;i.cot=1}if(i.lm>0)c[ns+'milestone']=i.lm;if(i.lom>0)c[ns+'offsetMilestone']=i.lom;if(v)for(x in c)v+=',contextData.'+x;pev3=c['a.contentType'];vo."
+"pe=pe;vo.pev3=pev3;var d=m.contextDataMapping,y,a,l,n;if(d){vo.events2='';if(v)v+=',events';for(x in d){if(x.substring(0,ns.length)==ns)y=x.substring(ns.length);else y=\"\";a=d[x];if(typeof(a)=='st"
+"ring'){l=m.s.sp(a,',');for(n=0;n<l.length;n++){a=l[n];if(x==\"a.contentType\"){if(v)v+=','+a;vo[a]=c[x]}else if(y=='view'||y=='segmentView'||y=='clicked'||y=='complete'||y=='timePlayed'||y=='CPM'){"
...
+"c[x+'Num']+':'+c[x]}else{if(v)v+=','+a;vo[a]=c[x]}}}else if(y=='milestones'||y=='offsetMilestones'){x=x.substring(0,x.length-1);if(c[x]&&d[x+'s'][c[x]]){if(e)e+=','+d[x+'s'][c[x]];vo.events2+=(vo.e"
+"vents2?',':'')+d[x+'s'][c[x]]}}if(c[x])c[x]=undefined;if(y=='segment'&&c[x+'Num'])c[x+\"Num\"]=undefined}}vo.linkTrackVars=v;vo.linkTrackEvents=e};m.bpe=function(vo,i,x,o){var m=this,pe='m_o',pev3,"
...
+"&x!=2?'L'+Math.floor(o):'');vo.pe=pe;vo.pev3=pev3};m.e=function(n,x,o,sn,sx,sl,pd){var m=this,i,tm=new Date,ts=Math.floor(tm.getTime()/1000),c,l,v=m.trackVars,e=m.trackEvents,ti=m.trackSeconds,tp=m"
+".trackMilestones,to=m.trackOffsetMilestones,sm=m.segmentByMilestones,so=m.segmentByOffsetMilestones,z=new Array,j,t=1,w=new Object,x,ek,tc,vo=new Object;if(!m.channel)m.channel=m.s.wd.location.host"
+"name;n=m.cn(n);i=n&&m.l&&m.l[n]?m.l[n]:0;if(i){if(i.ad){ti=m.adTrackSeconds;tp=m.adTrackMilestones;to=m.adTrackOffsetMilestones;sm=m.adSegmentByMilestones;so=m.adSegmentByOffsetMilestones}if(o<0){i"
+"f(i.lx==1&&i.lt>0)o=(ts-i.lt)+i.lo;else o=i.lo}if(i.l>0)o=o<i.l?o:i.l;if(o<0)o=0;i.o=o;if(i.l>0){i.x=(i.o/i.l)*100;i.x=i.x>100?100:i.x}if(i.lo<0)i.lo=o;tc=i.tc;w.name=n;w.ad=i.ad;w.length=i.l;w.ope"
+"nTime=new Date;w.openTime.setTime(i.s*1000);w.offset=i.o;w.percent=i.x;w.playerName=i.p;if(i.to<0)w.mediaEvent=w.event='OPEN';else w.mediaEvent=w.event=(x==1?'PLAY':(x==2?'STOP':(x==3?'MONITOR':(x="
...
+"if((x<=3||x>=5)&&i.to>=0){t=0;v=e=\"None\";if(i.to!=o){l=i.to;if(l>o){l=i.lo;if(l>o)l=o}z=tp?m.s.sp(tp,','):0;if(i.l>0&&z&&o>=l)for(j=0;j<z.length;j++){c=z[j]?parseFloat(''+z[j]):0;if(c&&(l/i.l)*10"
+"0<c&&i.x>=c){t=1;j=z.length;w.mediaEvent=w.event='MILESTONE';i.lm=w.milestone=c}}z=to?m.s.sp(to,','):0;if(z&&o>=l)for(j=0;j<z.length;j++){c=z[j]?parseFloat(''+z[j]):0;if(c&&l<c&&o>=c){t=1;j=z.lengt"
+"h;w.mediaEvent=w.event='OFFSET_MILESTONE';i.lom=w.offsetMilestone=c}}}}if(i.sg||!sx){if(sm&&tp&&i.l>0){z=m.s.sp(tp,',');if(z){z[z.length]='100';l=0;for(j=0;j<z.length;j++){c=z[j]?parseFloat(''+z[j]"
+"):0;if(c){if(i.x<c){sn=j+1;sx='M:'+l+'-'+c;j=z.length}l=c}}}}else if(so&&to){z=m.s.sp(to,',');if(z){z[z.length]=''+(i.l>0?i.l:'E');l=0;for(j=0;j<z.length;j++){c=z[j]?parseFloat(''+z[j]):0;if(c||z[j"
+"]=='E'){if(o<c||z[j]=='E'){sn=j+1;sx='O:'+l+'-'+c;j=z.length}l=c}}}}if(sx)i.sg=1}if((sx||i.sx)&&sx!=i.sx){i.us=1;if(!i.sx){i.sn=sn;i.sx=sx}if(i.to>=0)t=1}if((x>=2||i.x>=100)&&i.lo<o){i.t+=o-i.lo;i."
...
+"||(x<=3&&i.x>=100)){if(i.lx!=2)i.e+='E'+Math.floor(o);x=0;v=e=\"None\";w.mediaEvent=w.event=\"CLOSE\"}if(x==7){w.clicked=i.clk=1;t=1}if(x==5||(m.completeByCloseOffset&&(!x||i.x>=100)&&i.l>0&&o>=i.l"
+"-m.completeCloseOffsetThreshold)){w.complete=i.co=1;t=1}ek=w.mediaEvent;if(ek=='MILESTONE')ek+='_'+w.milestone;else if(ek=='OFFSET_MILESTONE')ek+='_'+w.offsetMilestone;if(!i.fel[ek]) {w.eventFirstT"
+"ime=true;i.fel[ek]=1}else w.eventFirstTime=false;w.timePlayed=i.t;w.segmentNum=i.sn;w.segment=i.sx;w.segmentLength=i.sl;if(m.monitor&&x!=4)m.monitor(m.s,w);if(x==0)m._delete(n);if(t&&i.tc==tc){vo=n"
+"ew Object;vo.contextData=new Object;vo.linkTrackVars=v;vo.linkTrackEvents=e;if(!vo.linkTrackVars)vo.linkTrackVars='';if(!vo.linkTrackEvents)vo.linkTrackEvents='';if(m.trackUsingContextData)m.bcd(vo"
+",i);else m.bpe(vo,i,x,o);m.s.t(vo);if(i.us){i.sn=sn;i.sx=sx;i.sc=1;i.us=0}else if(i.ts>0)i.sc=0;i.e=\"\";i.lm=i.lom=0;i.ts-=Math.floor(i.ts);i.to=o;i.tc++}}}return i};m.ae=function(n,l,p,x,o,sn,sx,"
...
+"new Function('o','var e,p=0;try{if(o.versionInfo&&o.currentMedia&&o.controls)p=1}catch(e){p=0}return p');p=tcf(o);if(!p){tcf=new Function('o','var e,p=0,t;try{t=o.GetQuickTimeVersion();if(t)p=2}cat"
+"ch(e){p=0}return p');p=tcf(o);if(!p){tcf=new Function('o','var e,p=0,t;try{t=o.GetVersionInfo();if(t)p=3}catch(e){p=0}return p');p=tcf(o)}}v=\"var m=s_c_il[\"+m._in+\"],o=m.ol['\"+i+\"']\";if(p==1)"
...
+"==8)x=0;if(n==3)x=1;if(n==1||n==2||n==4||n==5||n==6)x=2;}';c2='if(x>=0)m.ae(mn,l,\"'+p+'\",x,x!=2?p:-1,0,\"\",0,0,o)}}';c=c1+c2;if(m.s.isie&&xc){x=m.s.d.createElement('script');x.language='jscript'"
...
+"p==2){p='QuickTime Player '+(o.GetIsQuickTimeRegistered()?'Pro ':'')+o.GetQuickTimeVersion();f1=f2;c=v+',n,x,t,l,p,p2,mn;if(o){mn=o.GetMovieName()?o.GetMovieName():o.GetURL();n=o.GetRate();t=o.GetT"
+"imeScale();l=o.GetDuration()/t;p=o.GetTime()/t;p2=o.'+f5+';if(n!=o.'+f4+'||p<p2||p-p2>5){x=2;if(n!=0)x=1;else if(p>=l)x=0;if(p<p2||p-p2>5)m.ae(mn,l,\"'+p+'\",2,p2,0,\"\",0,0,o);m.ae(mn,l,\"'+p+'\","
+"x,x!=2?p:-1,0,\"\",0,0,o)}if(n>0&&o.'+f7+'>=10){m.ae(mn,l,\"'+p+'\",3,p,0,\"\",0,0,o);o.'+f7+'=0}o.'+f7+'++;o.'+f4+'=n;o.'+f5+'=p;setTimeout(\"'+v+';o.'+f2+'(0,0)\",500)}';o[f1]=new Function('a','b"
+"',c);o[f4]=-1;o[f7]=0;o[f1](0,0)}if(p==3){p='RealPlayer '+o.GetVersionInfo();f1=n+'_OnPlayStateChange';c1=v+',n,x=-1,l,p,mn;if(o){mn=o.GetTitle()?o.GetTitle():o.GetSource();n=o.GetPlayState();l=o.G"
+"etLength()/1000;p=o.GetPosition()/1000;if(n!=o.'+f4+'){if(n==3)x=1;if(n==0||n==2||n==4||n==5)x=2;if(n==0&&(p>=l||p==0))x=0;if(x>=0)m.ae(mn,l,\"'+p+'\",x,x!=2?p:-1,0,\"\",0,0,o)}if(n==3&&(o.'+f7+'>="
...
+"new Function('a','b',c1+'setTimeout(\"'+v+';o.'+f1+'(0,0)\",o.'+f3+'?500:5000);'+c2);o[f4]=-1;if(m.s.isie)o[f3]=1;o[f7]=0;o[f1](0,0)}};m.as=new Function('e','var m=s_c_il['+m._in+'],l,n;if(m.autoTr"
+"ack&&m.s.d.getElementsByTagName){l=m.s.d.getElementsByTagName(m.s.isie?\"OBJECT\":\"EMBED\");if(l)for(n=0;n<l.length;n++)m.a(l[n]);}');if(s.wd.attachEvent)s.wd.attachEvent('onload',m.as);else if(s."
+"wd.addEventListener)s.wd.addEventListener('load',m.as,false);if(m.onLoad)m.onLoad(s,m)";
s_ce.m_i("Media");

/* Configure Modules and Plugins */

s_ce.loadModule("Media");
s_ce.Media.autoTrack = false;
s_ce.Media.trackWhilePlaying = true;
s_ce.Media.trackVars = "None";
s_ce.Media.trackEvents = "None";

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s_ce.visitorNamespace = "experianinteractive";
s_ce.trackingServer = "experianinteractive.122.2o7.net";
// s_ce.trackingServerSecure = "experianinteractive.122.2o7.net";
// s_ce.dc = 122;
