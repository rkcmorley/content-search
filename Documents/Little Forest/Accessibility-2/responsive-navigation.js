...
//underline animation
$(function(){
    $('li.desktop-li > a').hover(function(){
        $(this).css({borderBottomWidth: '3px' }).animate({ borderBottomColor: '#FFF'});
    }, function() {
        $(this).css({borderBottomWidth: '3px'}).animate({ borderBottomColor: '#015cad'});
    });
});

//underline animation end

//drop menu animation start
$(function(){
